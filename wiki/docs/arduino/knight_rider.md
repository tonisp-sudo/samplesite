...
* Learning how to use arrays to control multiple LEDs
* Understanding the concept of timing and delay in Arduino
* Creating a decorative light effect using simple hardware
...
![Project Schematic](../assets/images/placeholder-schematic.png)
